...
qb_suite(test_memory, "memory", {
    ...
    qb_describe("Block: built-in", {
        ...
        qb_test("ref", {
            ...
            qb_assert(data->to_str() == "@eng:true");
        })
        ...
        qb_test("ref_slice", {
            ...
            qb_assert(data->to_str() == "@eng:true[1~3][2~4]");
        })
        ...
        qb_test("multiple", {
            ...
            qb_assert(block.data.__cpp_get<qb::mem::Reference>(6)->to_str() == "@eng:true");
        })
    ...
    qb_describe("Block: vec", {
        ...
        qb_test("vec<1>[ref]", {
            ...
            qb_assert(data->size() == 2);
            qb_assert(data->__cpp_get<qb::mem::Reference>(0)->to_str() == "@eng:true");
            qb_assert(data->__cpp_get<qb::mem::Reference>(1)->to_str() == "@nod:2");
        })
    ...
    qb_describe("Block: map", {
        ...
        qb_test("map{ref}", {
            ...
            qb_assert(data->size() == 2);
            qb_assert(data->__cpp_get<qb::mem::Reference>("a")->to_str() == "@eng:true");
            qb_assert(data->__cpp_get<qb::mem::Reference>("b")->to_str() == "@nod:2");
        })
